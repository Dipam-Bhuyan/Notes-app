...
<body>
    ...
    <section class="container py-4">
        <div class="row">
            <div class="col-md-12">
                <article class="align-items-center text-center p-5 mb-4">
                <h2>About Our Note-Taking App</h2>
                <hr class="custom-hr-1 my-3">
                <br>
                <p>
                    Welcome to our note-taking app, the perfect tool to help you organize your thoughts, ideas, and tasks. Our app is designed with simplicity and efficiency in mind, making it easy for you to jot down notes and keep your life well-organized.
                </p>
                <p>
                    Whether you're a student, professional, or simply someone who wants to keep their life in order, our note-taking app is here to simplify your note-taking experience. Get started today and never miss a beat!
                </p>
                </article>
            </div>
            <div class="col-md-12">
                <article class="align-items-center text-center p-3 mb-4">
                    <h2>Development Team</h2>
                    <hr class="custom-hr-2 my-3">
                    <div class="container marketing">
                        <div class="row">
                            <div class="col-lg-3">
                                <img class="rounded-circle" src="{{ asset('images/a.jpg') }}" alt="Generic placeholder image" width="140" height="140">
                                <h5>Anupam Borah</h5>
                                <p>202102022096<br>
                                B.Tech 3rd year (CSE)</p>
                            </div>
                            <div class="col-lg-3">
                                <img class="rounded-circle" src="{{ asset('images/d.jpg') }}" alt="Generic placeholder image" width="140" height="140">
                                <h5>Dipam Bhuyan</h5>
                                <p>202102022093<br>
                                B.Tech 3rd year(CSE)</p>
                            </div>
                            <div class="col-lg-3">
                                <img class="rounded-circle" src="{{ asset('images/r.jpg') }}" alt="Generic placeholder image" width="140" height="140">
                                <h5>Rajendra Oraon</h5>
                                <p>202102021050 <br>
                                B.Tech 3rd year (CSE)</p>
                            </div>
                            <div class="col-lg-3">
                                <img class="rounded-circle" src="{{ asset('images/s.jpg') }}" alt="Generic placeholder image" width="140" height="140">
                                <h5>Simanta Kumar Das</h5>
                                <p>202102021019<br>
                                B.Tech 3rd year(CSE)</p>
                            </div>
                        </div><!-- /.row -->
